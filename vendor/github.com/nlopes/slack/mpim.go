...
func (api *Client) mpimRequest(ctx context.Context, path string, values url.Values, debug bool) (*mpimResponseFull, error) {
...
func (api *Client) CloseMpIMChannelContext(ctx context.Context, channel string) (bool, bool, error) {
	...
	response, err := api.mpimRequest(ctx, "mpim.close", values, api.debug)
	if err != nil {
...
func (api *Client) OpenMpIMChannelContext(ctx context.Context, users []string) (bool, bool, string, error) {
	...
	response, err := api.mpimRequest(ctx, "mpim.open", values, api.debug)
	if err != nil {
		return false, false, "", err
	}
...
func (api *Client) MarkMpIMChannelContext(ctx context.Context, channel, ts string) (err error) {
	...
	_, err = api.mpimRequest(ctx, "mpim.mark", values, api.debug)
	if err != nil {
		return err
	}
	return
...
func (api *Client) GetMpIMHistoryContext(ctx context.Context, channel string, params HistoryParameters) (*History, error) {
	...
	response, err := api.mpimRequest(ctx, "mpim.history", values, api.debug)
	if err != nil {
		return nil, err
	}
...
func (api *Client) GetMpIMChannelsContext(ctx context.Context) ([]MpIM, error) {
	...
	response, err := api.mpimRequest(ctx, "mpim.list", values, api.debug)
	if err != nil {
		return nil, err
	}
