...
# Compatibility
* Matterircd v0.11.0 works with mattermost 3.5.0 [3.5.0 release](https://github.com/mattermost/platform/releases/tag/v3.5.0)
...
* For use with mattermost 3.5.0 and higher [v0.11.0](https://github.com/42wim/matterircd/releases/tag/v0.11.0)
