...
# Compatibility
* Matterircd v0.9.0 works with mattermost 3.0.0 and higher [3.2.0 release](https://github.com/mattermost/platform/releases/tag/v3.2.0)
...
* For use with mattermost 3.0.0+ [v0.9.0-beta1](https://github.com/42wim/matterircd/releases/tag/v0.9.0-beta1)
