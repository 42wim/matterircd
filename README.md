...
# Compatibility
* Matterircd v0.16.7 works with slack and mattermost 3.8.x - 3.10.0, 4.x
...
* For use with mattermost 3.8.0 and higher [v0.16.7](https://github.com/42wim/matterircd/relases/latest)
