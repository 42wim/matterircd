...
# Compatibility
* Matterircd v0.10.1 works with mattermost 3.3.0 and higher [3.3.0 release](https://github.com/mattermost/platform/releases/tag/v3.3.0)
...
* For use with mattermost 3.3.0 [v0.10.1](https://github.com/42wim/matterircd/releases/tag/v0.10.1)
