...
# Compatibility
* Matterircd v0.10.2 works with mattermost 3.3.0 and higher [3.4.0 release](https://github.com/mattermost/platform/releases/tag/v3.4.0)
...
* For use with mattermost 3.3.0 and higher [v0.10.2](https://github.com/42wim/matterircd/releases/tag/v0.10.2)
