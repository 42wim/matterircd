...
# Compatibility
* Matterircd v0.16.2 works with slack (initial support) and mattermost 3.8.x - 3.10.0, 4.x
...
* For use with mattermost 3.8.0 and higher [v0.16.2](https://github.com/42wimterircd/relases/latest)
